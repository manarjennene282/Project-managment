...
getrelprojet: async () => {
  ...
  try {
    const response = await axios.get(`${API_URL}/parametrage/relprojet`, {
      headers: {
        Authorization: `Bearer ${token}`, 
      },
    });
    ...
    console.error("Erreur lors de la récupération des relprojet :", error);
    throw error;
  }
},
...
/**
 * Ajouter une priorité.
 * @param {Object} relprojet - Données de la priorité à ajouter.
 * @returns {Promise} - Promesse contenant la réponse de l'API.
 */
addrelprojet: async (relprojet) => {
  try {
    const token = localStorage.getItem("token"); 
    const response = await axios.post(`${API_URL}/parametrage/relprojet`, relprojet, {
      headers: {
        Authorization: `Bearer ${token}`, 
      },
    });
    ...
    console.error("Erreur lors de l'ajout de la relprojet :", error);
    throw error;
  }
},
 ...
 * @returns {Promise} - Promesse contenant la réponse de l'API.
 */
updaterelprojet: async (id, relprojet) => {
  try {
    const token = localStorage.getItem("token");

    const response = await axios.put(`${API_URL}/parametrage/relprojet/${id}`, relprojet, {
      headers: {
        Authorization: `Bearer ${token}`, 
      },
    });
    ...
    console.error("Erreur lors de la mise à jour de la relprojet :", error);
    throw error;
  }
},
 ...
 * @returns {Promise} - Promesse contenant la réponse de l'API.
 */
deleterelprojet: async (id) => {
  try {
    const token = localStorage.getItem("token"); 
    const response = await axios.delete(`${API_URL}/parametrage/relprojet/${id}`, {
      headers: { Authorization: `Bearer ${token}` },
    });
    ...
    console.error("Erreur lors de la suppression de la relprojet :", error);
    throw error;
  }
},
 ...
 * @returns {Promise} - Promesse contenant la réponse de l'API.
 */
deletetypeequipement: async (id) => {
  try {
    const token = localStorage.getItem("token"); 
    const response = await axios.delete(`${API_URL}/parametrage/typeequipement/${id}`, {
      headers: { Authorization: `Bearer ${token}` },
    });
    ...
    console.error("Erreur lors de la suppression de la typeequipement :", error);
    throw error;
  }
},
