...
const ModifeRessourceHumaine = ({ open, onClose, ressource, onUpdate }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await RessourceHumaineService.updateRessourcehumaine(formData.id_ressh, formData);
      onUpdate(formData);
    ...
    <Modal open={open} onClose={onClose}>
      ...
      >
        <Typography variant="h6" mb={2}>
          Modifier une Ressource Humaine
        </Typography>
...
export default ModifeRessourceHumaine;
