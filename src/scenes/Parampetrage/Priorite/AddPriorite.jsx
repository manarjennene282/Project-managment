...
function AddPriorite({ open, onClose, onAddPriorite }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await Parametrageservice.addPriorite(formData);
      ...
      setError("Une erreur est survenue lors de l'ajout de la priorité.");
    } finally {
      setLoading(false);
    }
  };
