...
class RessourceMaterielController extends Controller
{
    ...
    {
        $RessourceMateriel = ressourcemateriel::all();
    ...
    public function store(ResourceRequest $request)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'data' => $RessourceMateriel,
                'message' => 'Ressource materiel ajoutée avec succès.',
            ], 201);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Une erreur est survenue lors de l\'ajout de la Ressource materiel.',
                'error' => $e->getMessage(),
            ], 500);
        }
    }
